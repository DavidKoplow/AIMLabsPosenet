        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, posenetModel.load(resNetConfig)];
                case 1:
                    resNet = _a.sent();
                    return [4 /*yield*/, posenetModel.load(mobileNetConfig)];
                case 2:
                    mobileNet = _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, resNet.estimateSinglePose(input, { flipHorizontal: false })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, mobileNet.estimateSinglePose(input, { flipHorizontal: false })];
                case 2:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    input = tf.zeros([inputResolution, inputResolution, 3]);
                    beforeTensors = tf.memory().numTensors;
                    return [4 /*yield*/, resNet.estimateMultiplePoses(input, {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, mobileNet.estimateMultiplePoses(input, {
                            flipHorizontal: false,
                            maxDetections: 5,
                            scoreThreshold: 0.5,
                            nmsRadius: 20
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, posenetModel.load({ architecture: 'MobileNetV1', outputStride: outputStride, inputResolution: inputResolution })];
                case 1:
                    model = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    validInputResolution = util_1.toValidInputResolution(inputResolution, outputStride);
                    expectedResolution = [validInputResolution, validInputResolution];
                    return [4 /*yield*/, posenetModel.load({ architecture: 'ResNet50', outputStride: outputStride, inputResolution: inputResolution })];
                case 1:
                    model = _a.sent();
                    expect(model.inputResolution).toEqual(expectedResolution);
                    return [2 /*return*/];
